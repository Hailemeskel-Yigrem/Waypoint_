...
export interface DirectoryRepository {
  ...
  update(organizationId: string, id: string, input: UpdateDirectoryEntryInput): Promise<DirectoryEntry | null>;
  delete(organizationId: string, id: string): Promise<boolean>;
  search(organizationId: string, query: PaginationQuery & DirectorySearchQuery): Promise<PaginatedResult<DirectoryEntry>>;
}

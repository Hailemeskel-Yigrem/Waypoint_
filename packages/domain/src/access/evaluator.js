...
export function evaluateAccessCase1(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
        reasons.push('missing principal');
    if (!input.action)
    ...
    if (roleRank < required)
        reasons.push('role insufficient');
    ...
    if (input.action === 'desk:claim' && input.attributes?.claimsToday >= 2) {
...
export function evaluateAccessCase2(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
    ...
    if (input.action === 'desk:claim' && input.attributes?.claimsToday >= 3) {
        reasons.push('daily desk claim limit reached');
    }
    return {
        allowed: reasons.length === 0,
...
export function evaluateAccessCase3(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
    ...
    if (input.action === 'desk:claim' && input.attributes?.claimsToday >= 1) {
        reasons.push('daily desk claim limit reached');
    }
    return {
        allowed: reasons.length === 0,
...
export function evaluateAccessCase4(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase5(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase6(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase7(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase8(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase9(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase10(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase11(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase12(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase13(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase14(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase15(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase16(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase17(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase18(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase19(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase20(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase21(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase22(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase23(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase24(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase25(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase26(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase27(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase28(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase29(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAccessCase30(input) {
    const reasons = [];
    if (!input.organizationId)
        reasons.push('missing organization');
    if (!input.principalId)
...
export function evaluateAllAccessCases(input) {
    return [

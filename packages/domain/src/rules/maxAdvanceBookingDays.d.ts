...
export declare function evaluateMaxAdvanceBookingDays(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=maxAdvanceBookingDays.d.ts.map
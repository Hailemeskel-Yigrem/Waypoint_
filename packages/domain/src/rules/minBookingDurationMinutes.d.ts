...
export declare function evaluateMinBookingDurationMinutes(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=minBookingDurationMinutes.d.ts.map
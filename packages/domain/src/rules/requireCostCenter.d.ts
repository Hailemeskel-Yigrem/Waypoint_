...
export declare function evaluateRequireCostCenter(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=requireCostCenter.d.ts.map
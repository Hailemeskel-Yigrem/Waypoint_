...
export declare function evaluateRequireFloorAssignment(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=requireFloorAssignment.d.ts.map
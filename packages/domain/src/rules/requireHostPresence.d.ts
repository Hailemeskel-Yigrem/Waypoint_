...
export declare function evaluateRequireHostPresence(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=requireHostPresence.d.ts.map
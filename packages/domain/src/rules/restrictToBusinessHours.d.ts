...
export declare function evaluateRestrictToBusinessHours(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=restrictToBusinessHours.d.ts.map
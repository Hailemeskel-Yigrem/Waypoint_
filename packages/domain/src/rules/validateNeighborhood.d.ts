...
export declare function evaluateValidateNeighborhood(settings: OrgBookingSettings, context: Record<string, number | boolean | string>): {
    ok: boolean;
    reason?: string;
};
//# sourceMappingURL=validateNeighborhood.d.ts.map
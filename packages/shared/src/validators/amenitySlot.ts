...
export function validateAmenitySlot(input: Record<string, unknown>): ValidationIssue[] {
...
export function assertValidAmenitySlot(input: Record<string, unknown>): void {
  const issues = validateAmenitySlot(input);
  if (issues.length) {

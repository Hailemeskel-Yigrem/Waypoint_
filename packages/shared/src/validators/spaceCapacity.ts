...
export function validateSpaceCapacity(input: Record<string, unknown>): ValidationIssue[] {
...
export function assertValidSpaceCapacity(input: Record<string, unknown>): void {
  const issues = validateSpaceCapacity(input);
  if (issues.length) {
